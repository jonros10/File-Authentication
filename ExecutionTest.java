import java.util.*;
/**
 * This class is the testing class of the project.
 * 
 * @author Maha Shamseddine.
 */
public class ExecutionTest{
    /**
     * This method is the main method which initiates the tests.
    ...
    public static void main(String[] args) {
        ...
        ArrayList<SiblingPair<String>> aprr = merkleTree.sendAppr(0);
        try {
            int size = aprr.size();
